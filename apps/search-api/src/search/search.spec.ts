...
describe('Intent-Aware Search System', () => {
  ...
  describe('OpenSearch Integration Tests', () => {
    ...
    describe('Dual Vector Search', () => {
      it('should search using item_vector for generic queries', async () => {
        // Generic "butter chicken" should use item_vector
        // This focuses on dish similarity across all stores
      });

      it('should search using store_item_vector for specific queries', async () => {
        // "butter chicken from Inayat" should use store_item_vector after store match
